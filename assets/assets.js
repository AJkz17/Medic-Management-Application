...
export const categories = ["Dental Care", "Cardiology", "General Checkup", "Pediatrics", "Dermatology", "Vaccination", "Physiotherapy", "Eye Clinic"];
...
export const patientFeedback = [
  {
    ...
    stars: "★★★★★",
    comment: "The booking process was so smooth. I managed to get my Dental appointment in seconds!"
  },
  {
    id: 2,
    name: "Sarah Jenkins",
